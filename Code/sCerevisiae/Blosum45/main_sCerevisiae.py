...
def main():
	...
	positive_A_mat_loc = "{}/input/sCerevisiaeData/P_protein_A.mat".format(project_base_dir)
	positive_B_mat_loc = "{}/input/sCerevisiaeData/P_protein_B.mat".format(project_base_dir)
	negative_A_mat_loc = "{}/input/sCerevisiaeData/N_protein_A.mat".format(project_base_dir)
	negative_B_mat_loc = "{}/input/sCerevisiaeData/N_protein_B.mat".format(project_base_dir)
	...
	if (not images_generated):
		...
		substituton_matrix_init(out_dir, 'bl', 45)
		
		parse_sCerevisiae_data(negative_A_mat_loc, negative_B_mat_loc, positive_A_mat_loc, positive_B_mat_loc, out_dir, True)
		copy_pos_neg_pkl_from_prev_parsing(out_dir, standard_save_loc)

		generate_images(orig_img_pos_out_pkl_loc, 'positive', out_dir)
		generate_images(orig_img_neg_out_pkl_loc, 'negative', out_dir)
		
		train_test_pkl_loc = createDataPartition(out_dir, 0.9, out_dir)
		shutil.copy(train_test_pkl_loc, standard_save_loc)
