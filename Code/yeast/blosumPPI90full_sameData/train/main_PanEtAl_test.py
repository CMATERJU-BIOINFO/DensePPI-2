...
def main():
	...
	model_saved_loc = "/media/ppin-1/DISC-1/test_code_integrity_aanzil/blosumPPI/JUPPIdBlosum90PPIComp/outputs/blosumJUPPId/C1_10_Fold/fold1/saved_models/complete_epoch_010_metric_0.99501.pth.tar"
