...
def main():
    ...
    testing_input_subfolder_name = "C1Set1"
    ...
    out_dir = "{}/outputs/blosum45JUPPId/{}/".format(curr_dir, testing_input_subfolder_name) #Use end slash
    ...
    model_saved_loc = train(train_parent_loc, modelSavePath, "complete", True, "complete_epoch_005_metric_0.97383.pth.tar")
